...
define([
    ...
    "use strict";
    /**
     * Constructs a Carbon monoxide map.
     * @constructor
     * @augments Layer
     */
    var co = function () {
        WorldWind.Layer.call(this, "CO");
        
        // Web Map Tiling Service information from
        var serviceAddress = "https://apps.ecmwf.int/wms/?token=public&service=WMS&request=GetCapabilities&version=1.3.0";
        var layerIdentifier = "composition_europe_co_forecast_surface";
        var self = this;
    ...
    co.prototype = Object.create(WorldWind.Layer.prototype);
     ...
     * @protected
     */
    co.prototype.doRender = function (dc) {
        if (this.wmsLayer) {
     ...
     * @protected
     */
    co.prototype.isLayerInView = function (dc) {
        if (this.wmsLayer) {
