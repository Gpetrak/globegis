...
define([
    ...
    var surface_water = function () {
        WorldWind.Layer.call(this, "Επιφανειακά Υδατικά Συστήματα");
        ...
        var layerIdentifier = "geonode:gr_gr13_swb_20150601_polyline_2100";
        var self = this;
    ...
    surface_water.prototype = Object.create(WorldWind.Layer.prototype);
     ...
     */
    surface_water.prototype.refresh = function () {
        if (this.wmsLayer) {
     ...
     * @protected
     */
    surface_water.prototype.doRender = function (dc) {
        if (this.wmsLayer) {
     ...
     * @protected
     */
    surface_water.prototype.isLayerInView = function (dc) {
        if (this.wmsLayer) {
