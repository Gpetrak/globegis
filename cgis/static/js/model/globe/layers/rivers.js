...
define([
    ...
    "use strict";
    /**
     * Constructs a Rivers map.
     * @constructor
     * @augments Layer
     */
    var rivers = function () {
        WorldWind.Layer.call(this, "Ποταμοί");
        ...
        var layerIdentifier = "geonode:potamoi";
        var self = this;
    ...
    rivers.prototype = Object.create(WorldWind.Layer.prototype);
     ...
     */
    rivers.prototype.refresh = function () {
        if (this.wmsLayer) {
     ...
     * @protected
     */
    rivers.prototype.doRender = function (dc) {
        if (this.wmsLayer) {
     ...
     * @protected
     */
    rivers.prototype.isLayerInView = function (dc) {
        if (this.wmsLayer) {
